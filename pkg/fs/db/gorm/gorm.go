...
func New(path, table string, db *gorm.DB) (f FileSystem, err error) {
	if db == nil {
...
func (f FileSystem) tx() (tx *gorm.DB) {
...
func (f FileSystem) getEntry(path string) (entry *File, err error) {
...
func (f FileSystem) getStub(path string) (stub *entryStub, err error) {
	realpath := f.realpath(path)
	stub = &entryStub{}
...
func (f FileSystem) getStamp(path string) (stamp *entryStamp, err error) {
	realpath := f.realpath(path)
	stamp = &entryStamp{}
...
// }
//
// func (f FileSystem) Rmdir(path string) (err error) {
// 	// must return an error if there are any children
// 	return
// }
//
// func (f FileSystem) RmdirAll(path string) (err error) {
// 	// delete all things with the prefix of `#{path}/%`
// 	return
// }
//
// func (f FileSystem) WriteFile(path, mime string, content []byte, ctx []byte) (err error) {
// 	var shasum string
...
// }
//
// func (f FileSystem) DeleteFile(path string) (err error) {
// 	realpath := f.realpath(path)
