...
func (t *Theme) RenderPage(ctx context.Context, p *page.Page) (data []byte, redirect string, err error) {
	...
	if gtmNonce := ctx.String("GoogleTagManagerHeadScriptNonce", ""); gtmNonce != "" {
		ctx.SetSpecific("GoogleTagManagerHeadScript", `<!-- Google Tag Manager -->
<script nonce="`+gtmNonce+`">(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','`+t.Config.GoogleAnalytics.GTM+`');</script>
<!-- End Google Tag Manager -->`)
		ctx.SetSpecific("GoogleTagManagerNoScript", `<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=`+t.Config.GoogleAnalytics.GTM+`"
