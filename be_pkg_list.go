...
func GoEnjinPackageList() (list []string) {
	list = append(list,
		...
		"github.com/go-enjin/be/pkg/fs/zip",
		...
		"github.com/go-enjin/be/features/fs/zips/content",
		...
		"github.com/go-enjin/be/features/pages/indexing/buntdb-indexing",
		"github.com/go-enjin/be/features/pages/indexing/leveldb-indexing",
		"github.com/go-enjin/be/features/pages/indexing/stock-kws",
