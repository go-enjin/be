...
func GoEnjinPackageList() (list []string) {
	list = append(list,
		...
		"github.com/go-enjin/be/pkg/feature/site-secure-context",
		"github.com/go-enjin/be/pkg/feature/uses-actions",
		"github.com/go-enjin/be/pkg/feature/uses-enjin-salt",
		"github.com/go-enjin/be/pkg/feature/uses-kvc",
		...
		"github.com/go-enjin/be/features/requests/pages/context-modifiers",
		...
		"github.com/go-enjin/be/features/site/fs-editor/enjin-info",
		...
		"github.com/go-enjin/be/features/site/fs-editor/themes",
		...
		"github.com/go-enjin/be/features/srv/kws",
