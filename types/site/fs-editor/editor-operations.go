...
func (f *CEditorFeature[MakeTypedFeature]) OpFileUnlockHandler(r *http.Request, pg feature.Page, ctx, form clContext.Context, info *feature.EditorFile, eid string) (redirect string) {
...
func (f *CEditorFeature[MakeTypedFeature]) OpFileRetakeHandler(r *http.Request, pg feature.Page, ctx, form clContext.Context, info *feature.EditorFile, eid string) (redirect string) {
...
func (f *CEditorFeature[MakeTypedFeature]) OpFileDeleteValidate(r *http.Request, pg feature.Page, ctx, form clContext.Context, info *feature.EditorFile, eid string) (err error) {
	printer := message.GetPrinter(r)
	if info.Locked {
...
func (f *CEditorFeature[MakeTypedFeature]) OpFileDeleteHandler(r *http.Request, pg feature.Page, ctx, form clContext.Context, info *feature.EditorFile, eid string) (redirect string) {
...
func (f *CEditorFeature[MakeTypedFeature]) OpPathDeleteValidate(r *http.Request, pg feature.Page, ctx, form clContext.Context, info *feature.EditorFile, eid string) (err error) {
	printer := message.GetPrinter(r)
...
func (f *CEditorFeature[MakeTypedFeature]) OpPathDeleteHandler(r *http.Request, pg feature.Page, ctx, form clContext.Context, info *feature.EditorFile, eid string) (redirect string) {
...
func (f *CEditorFeature[MakeTypedFeature]) OpFileCommitValidate(r *http.Request, pg feature.Page, ctx, form clContext.Context, info *feature.EditorFile, eid string) (err error) {
	printer := message.GetPrinter(r)
	if info.Locked {
...
func (f *CEditorFeature[MakeTypedFeature]) OpFileCommitHandler(r *http.Request, pg feature.Page, ctx, form clContext.Context, info *feature.EditorFile, eid string) (redirect string) {
...
func (f *CEditorFeature[MakeTypedFeature]) OpFilePublishValidate(r *http.Request, pg feature.Page, ctx, form clContext.Context, info *feature.EditorFile, eid string) (err error) {
	printer := message.GetPrinter(r)
	if info.Locked {
...
func (f *CEditorFeature[MakeTypedFeature]) OpFilePublishHandler(r *http.Request, pg feature.Page, ctx, form clContext.Context, info *feature.EditorFile, eid string) (redirect string) {
...
func (f *CEditorFeature[MakeTypedFeature]) OpFileCancelValidate(r *http.Request, pg feature.Page, ctx, form clContext.Context, info *feature.EditorFile, eid string) (err error) {
	printer := message.GetPrinter(r)
	if info.Locked {
...
func (f *CEditorFeature[MakeTypedFeature]) OpFileCancelHandler(r *http.Request, pg feature.Page, ctx, form clContext.Context, info *feature.EditorFile, eid string) (redirect string) {
	if stop := f.Emit(feature.PrePublishFileSignal, f.Tag().String(), r, pg, ctx, form, info, eid, &redirect); stop {
		return
	}
...
func (f *CEditorFeature[MakeTypedFeature]) OpFileMoveValidate(r *http.Request, pg feature.Page, ctx, form clContext.Context, info *feature.EditorFile, eid string) (err error) {
	printer := message.GetPrinter(r)
	if info.Locked {
		err = errors.New(printer.Sprintf("file is locked by another user, cannot move"))
	}
...
func (f *CEditorFeature[MakeTypedFeature]) OpFileMoveHandler(r *http.Request, pg feature.Page, ctx, form clContext.Context, info *feature.EditorFile, eid string) (redirect string) {
...
func (f *CEditorFeature[MakeTypedFeature]) OpFileCopyValidate(r *http.Request, pg feature.Page, ctx, form clContext.Context, info *feature.EditorFile, eid string) (err error) {
	return
}

func (f *CEditorFeature[MakeTypedFeature]) OpFileCopyHandler(r *http.Request, pg feature.Page, ctx, form clContext.Context, info *feature.EditorFile, eid string) (redirect string) {
...
func (f *CEditorFeature[MakeTypedFeature]) OpFileTranslateValidate(r *http.Request, pg feature.Page, ctx, form clContext.Context, info *feature.EditorFile, eid string) (err error) {
	//printer := message.GetPrinter(r)
	//if info.Locked {
...
func (f *CEditorFeature[MakeTypedFeature]) OpFileTranslateHandler(r *http.Request, pg feature.Page, ctx, form clContext.Context, info *feature.EditorFile, eid string) (redirect string) {
